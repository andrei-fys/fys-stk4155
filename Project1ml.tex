...
\begin{figure}
	...
	\caption{ BV MSE } \label{plt:no_sampling_Franke_3m_BVMSE}
\end{figure}


\begin{figure}
	\centerline{\includegraphics[scale=0.9]{With_sampling_3M_Franke.pdf}}
	\caption{ BV MSE } \label{plt:with_sampling_Franke_3m_BVMSE}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=0.9]{Franke_fitted_OLS.pdf}}
	\caption{The  Franke function fitted by OLS, no resampling} \label{plt:Franke_fitted_OLS}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=0.9]{Franke_fitted_Ridge.pdf}}
	\caption{The  Franke function fitted by Ridge, no resampling} \label{plt:Franke_fitted_Ridge}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=1.0]{confidenceCVnoisy.pdf}}
	\label{plt:BetaNoiseCV}
	\caption{ resampling noise}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=1.0]{confidencenoCVnoisy.pdf}}
	\label{plt:BetaNoiseNoCV}
	\caption{ no resampling noise}
\end{figure}
...
We begin with the fitting of Franke function. On Fig. $\ref{plt:Franke_fitted_OLS}$ and Fig. $\ref{plt:Ridge_CV_bias_MSE_w_resample}$ one may see how the function have been fitted using the OLS and Ridge regression. 
